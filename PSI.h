...
private:
    ...
    void find_k_nearest_neighbour_recursive(PSIBallTree * root, const double * target, double ** base,
...
public:
    ...
    int * find_k_nearest_neighbour(double * target, double ** points, PSIBallTree * btree, int k);
    int * find_k_nearest_neighbour(double * target, int k);
    int * projective_simplex_algorithm(int * neighbours, double * target, int k);
    int * adaptive_projective_simplex_algorithm(double * target, int k, double factor, int max_steps);
    double * interpolat(double * target);
};
